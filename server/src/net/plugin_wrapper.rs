...
impl PluginInterface for PluginWrapper {
    ...
    fn handle_player_avatar_change(
        ...
        self.wrap_calls(net, |plugin_interface, net| {
            acknowledged &= plugin_interface.handle_player_avatar_change(
                net,
                player_id,
                texture_path,
                animation_path,
    ...
    fn handle_player_name_change(&mut self, net: &mut Net, player_id: ActorId, name: &str) -> bool {
        ...
        self.wrap_calls(net, |plugin_interface, net| {
            prevent_default |= plugin_interface.handle_player_name_change(net, player_id, name)
        });
    ...
    fn handle_player_emote(&mut self, net: &mut Net, player_id: ActorId, emote_id: &str) -> bool {
        ...
        self.wrap_calls(net, |plugin_interface, net| {
            acknowledged &= plugin_interface.handle_player_emote(net, player_id, emote_id)
        });
