...
TornadoCardAction::TornadoCardAction(std::shared_ptr<Character> actor, int damage) : CardAction(actor, "PLAYER_SHOOTING"),
...
void TornadoCardAction::OnExecute(std::shared_ptr<Character> user) {
