...
int main(int argc, char** argv) {
  ...
  */
  ...
  // Log output text
  Font font = Font(Font::Style::small);
  ...
  // Press Start text
  Font startFont = Font(Font::Style::thick);
  ...
  navisLoadedLabel.setScale(2.f, 2.f);
  ...
  mobLoadedLabel.setScale(2.f, 2.f);
    ...
    */
    ...
    ENGINE.Clear();
      ...
      for (int i = 0; i < logs.size(); i++) {
          ...
          logLabel.setPosition(0.f, 320 - (i * font.GetLineHeight() * 2.f) - font.GetLineHeight() - 1.0f);
