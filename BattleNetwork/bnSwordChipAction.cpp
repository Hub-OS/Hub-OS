...
SwordChipAction::SwordChipAction(Character * owner, int damage) : ChipAction(owner, "PLAYER_SWORD", &attachment, "HILT"), attachmentAnim(ANIM) {
  this->damage = damage;
...
SwordChipAction::~SwordChipAction()
{
  if (attachment) {
    delete attachment;
  }
...
void SwordChipAction::OnSpawnHitbox()
{
...
void SwordChipAction::SetElement(Element elem)
{
  element = elem;
}

const Element SwordChipAction::GetElement() const
{
  return element;
}

void SwordChipAction::OnUpdate(float _elapsed)
{
...
void SwordChipAction::EndAction()
{
