...
deck-list-filter-menu-label = FILTRO
deck-list-option-search = PESQUISAR
deck-list-option-filter-tag = FILTRAR TAG
deck-list-option-edit-tags = EDITAR TAGS
deck-list-tags-menu-label = TAGS
deck-list-tags-option-no-filter = (Nenhum)
deck-list-tags-option-new-tag = Nova Tag
deck-list-tags-option-rename = Renomear Tag
deck-list-tags-option-delete = Apagar Tag
deck-list-tags-option-cancel = Cancelar
